...
use app\modules\edu\models\EduSpecialisationsSearch;
use Yii;
 ...
 */
class EduSpecialisationsController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new EduSpecialisationsSearch();
        $searchModel->status = EduSpecialisation::STATUS_ACTIVE;
    ...
    {
        if (($model = EduSpecialisation::findOne(['id' => $id])) !== null) {
            return $model;
        }
